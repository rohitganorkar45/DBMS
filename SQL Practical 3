...
(101, 'Vineet Mohod', 'vineet@example.com', '123456789012', 1),
(102, 'Riyanshu Zannzal', 'riyanshu@example.com', '234567890123', 2),
(103, 'Saumitra Tambekar', 'saummitra@example.com', '345678901234', 1);
SELECT * FROM student;
